                        ...
                        <div class="flex-1 pl-3">
                            <div class="flex justify-between items-center">
                                <div>
                                    ...
                                    <small
                                        class="ml-2 text-sm text-gray-600 dark:text-gray-100">{{ idea->created_at }}</small>
                                    @unless ($idea->created_at->eq($chirp->updated_at))
                            ...
                            <p class="mt-3 text-lg text-gray-900 dark:text-gray-100">{{ $idea->title }}
                            </p>
